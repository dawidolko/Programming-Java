//[Programowanie Java GUI - lekcja 20: JPopupMenu] - https://www.youtube.com/watch?v=otj81U7PK_Q&list=PL3298E3EB8CFDE9BA&index=20
...
public class JPopupMenuu extends JFrame implements ActionListener {
    ...
    public JPopupMenuu(){
        setTitle("Demonstacja JPopupMenu");
        setSize(800,800);
    ...
    public static void main(String[] args) {
        JPopupMenuu appMenu = new JPopupMenuu();
